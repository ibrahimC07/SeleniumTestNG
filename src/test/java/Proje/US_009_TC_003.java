...
//        pmp.shippingWeight.sendKeys("yuz gram");
...
//        Assert.assertFalse(!ReusableMethods.waitForVisibility(pmp.productPublishedText,15).isDisplayed());
//        //sayfayi kapat
//        Driver.closeDriver();
//
//
