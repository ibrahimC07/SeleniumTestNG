...
//        Select select;
//        select = new Select(pmp.addProductSimpleProduct);
...
//        //   Kullanici "Manage Stock" kutucugunu isaretler
//        WebDriverWait wait = new WebDriverWait(Driver.getDriver(), 10);
//        WebElement element = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("#manage_stock")));
//        ((JavascriptExecutor) Driver.getDriver()).executeScript("arguments[0].click();", element);
//        //Kullanici acilan Stock Qty alani doldurulur
//        ReusableMethods.jsclick(pmp.productStockQty);
//        actions.sendKeys(pmp.productStockQty, Keys.BACK_SPACE).perform();
//        pmp.productStockQty.sendKeys("40");
//        // Kullanici "allow backorder" seceneginden "allow"a basar
//        Select select1;
//        select1 = new Select(pmp.productAllowBackorders);
//        select1.selectByIndex(1);
//        //Girilen secenegin isaretlendigi dogrulanir
//        String expectedResult="Allow, but notify customer";
